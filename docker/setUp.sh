...
if [ ! -z "$ORG_NAME" ]; then
  mkdir -p $DESTINATION_DIR/$CRYPTO/peers/$PEER.$ORG_NAME
  mkdir -p $DESTINATION_DIR/$CRYPTO/users/$ADMIN_USER_NAME@$ORG_NAME
...
if [ ! -z "$ORG_NAME" ]; then
  cp -av  $FUSE_MOUNT_DIR/$CRYPTO/peers/$PEER.$ORG_NAME/* $DESTINATION_DIR/$CRYPTO/peers/$PEER.$ORG_NAME/
  cp -av  $FUSE_MOUNT_DIR/$CRYPTO/users/$ADMIN_USER_NAME@$ORG_NAME/* $DESTINATION_DIR/$CRYPTO/users/$ADMIN_USER_NAME@$ORG_NAME/
